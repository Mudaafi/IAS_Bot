...
function restrictChatMember(chat_id, user_id, permissions, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/restrictChatMember', {
        chat_id: chat_id,
        user_id: user_id,
      ...
      .catch((err) => {
        if (
          err.response &&
          err.response.data.description == 'Bad Request: chat not found'
        ) {
          console.log(
            'Chat not found when restricting user ( ' +
              user_id +
              ') from chat: ' +
              chat_id,
          );
          ...
          err.response &&
          err.response.data.description == 'Bad Request: user not found'
        ) {
...
function unbanChatMemeber(chat_id, user_id, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/unbanChatMember', {
        chat_id: chat_id,
        user_id: user_id,
      })
      .then((response) => {
        // We get here if the message was successfully posted
        console.log(
          'Chat member unbanned: ' + user_id + ' from chat: ' + chat_id,
        );
        resolve();
        return;
        //res.end("ok");
      ...
      .catch((err) => {
        if (
          ...
          console.log(
            'Error unbanning user ( ' + user_id + ') from chat: ' + chat_id,
          );
          resolve('chat_id error');
          return;
        }
...
function kickChatMember(chat_id, user_id, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/kickChatMember', {
        chat_id: chat_id,
        user_id: user_id,
      })
      .then((response) => {
        // We get here if the message was successfully posted
        console.log(
          'Chat member kicked: ' + user_id + ' from chat: ' + chat_id,
        );
        resolve();
        return;
        //res.end("ok");
      ...
      .catch((err) => {
        if (
          ...
          console.log(
            'Error kicking user ( ' + user_id + ') from chat: ' + chat_id,
          );
          resolve('chat_id error');
          return;
        } else if (
...
function deleteMessage(chat_id, msg_id, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/deleteMessage', {
        chat_id: chat_id,
        message_id: msg_id,
      })
      .then((response) => {
    ...
    axios
      ...
      .catch((err) => {
        if (
          err.response &&
          err.response.data.description ==
            'Bad Request: not enough rights to export chat invite link'
        ) {
...
function updateMessage(chat_id, msg_id, text, reply_markup, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/editMessageText', {
        chat_id: chat_id,
        message_id: msg_id,
        text: text,
        parse_mode: 'HTML',
      ...
      .catch((err) => {
        if (
          ...
          console.log(
            'TempMsgRecords contains outdated data (' +
              chat_id +
              ', ' +
              msg_id +
              ')',
          ...
          console.log(
            'Weird Update Msg Error (' + chat_id + ', ' + msg_id + ')',
          );
          ...
          err.response &&
          err.response.data.description == 'Bad Request: not Found'
        ) {
...
function forwardMsg(srcId, destId, message, bot_key) {
  ...
  if (message.reply_markup || message.poll) {
    sendMessage(
      srcId,
      'Sorry, polls and such are not allowed as of yet :(',
      {},
      bot_key,
    );
...
function sendAudio(id, audio, caption, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendAudio', {
        chat_id: id,
        audio: audio,
        caption: caption,
        parse_mode: 'HTML',
...
function sendDocument(id, doc, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendDocument', {
        chat_id: id,
        document: doc,
      })
      .then((response) => {
...
function sendVoice(id, voice, caption, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendVoice', {
        chat_id: id,
        voice: voice,
        caption: caption,
        parse_mode: 'HTML',
...
function sendVideoNote(id, videoNote, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendVideoNote', {
        chat_id: id,
...
function sendVideo(id, video, caption, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendVideo', {
        chat_id: id,
        video: video,
        caption: caption,
        parse_mode: 'HTML',
...
function sendPhoto(id, photo, caption, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendPhoto', {
        chat_id: id,
        photo: photo,
        caption: caption,
        parse_mode: 'HTML',
...
function sendSticker(id, sticker, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendSticker', {
        chat_id: id,
...
function sendMessage(id, text, reply_markup, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/sendMessage', {
        chat_id: id,
        text: text,
        parse_mode: 'HTML',
        reply_markup: reply_markup,
...
function leaveChat(chat_id, bot_key) {
  return new Promise((resolve, reject) => {
    axios
      .post('https://api.telegram.org/bot' + bot_key + '/leaveChat', {
        chat_id: chat_id,
      })
      .then((response) => {
        // We get here if the message was successfully posted
